...
async function createPlayerPictureText(allTime, monthly, weekly, skinData, transparent, unbaked, parallel) {
	//variable prep
	...
	//image start
	const bgNumber = getRandomNumber(1, 9);
	var fileName;
	if (!transparent) {
	...
	var t1 = Date.now();
	let [bgImage, overlay, bakedText] = await Promise.all([Jimp.read(fileName), Jimp.read("./assets/overlay.png"), Jimp.read("./assets/baked.png")]);
	if (!transparent) {
	...
	async function drawName() {
		...
		bgImage = await drawMulticoloredText(
			...
			185,
			0.55,
			[[`${lastSeen} (`, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 2, false], onlineStatus, [")", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 2, false], [`[${lastSeenLocation}]`, "#AAAAAA", true, shadowColor("#FFFFFF", 0.2), 2, false]],
			true
		);
	}
	const statsBase = 300;
	...
	async function drawGstats() {
		...
		if (gStatsGame == "bedwars") {
			...
			bgImage = await drawText(bgImage, "Bedwars", imgWidth / 2 + 350, gStatsBase - 5, 0.65, "#ffffff", true, shadowColor("#ffffff", 0.2), 4, true, true);
			bgImage = await drawMulticoloredText(
				bgImage,
				leftRowCenter,
				gStatsBase + 20,
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Beds Broken", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Final Kills", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Iron", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Gold", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Diamonds", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Emeralds", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawText(bgImage, `${kills}`, leftRowCenter + 5, gStatsBase + 20, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${deaths}`, leftRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${wins}`, leftRowCenter + 5, gStatsBase + 60, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${bedsBroken}`, leftRowCenter + 5, gStatsBase + 80, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${finalKills}`, leftRowCenter + 5, gStatsBase + 100, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);

			bgImage = await drawText(bgImage, `${ironCollected}`, rightRowCenter + 5, gStatsBase + 20, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${goldCollected}`, rightRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${diamondsCollected}`, rightRowCenter + 5, gStatsBase + 60, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${emeraldsCollected}`, rightRowCenter + 5, gStatsBase + 80, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(kills / deaths)}`, rightRowCenter + 5, gStatsBase + 100, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			...
			bgImage = await drawText(bgImage, "Skywars", imgWidth / 2 + 350, gStatsBase - 5, 0.65, "#ffffff", true, shadowColor("#ffffff", 0.2), 4, true, true);
			bgImage = await drawMulticoloredText(
				bgImage,
				leftRowCenter,
				gStatsBase + 20,
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Coins", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Placed", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Broken", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Pearls", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Eggs", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawText(bgImage, `${deaths}`, leftRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${wins}`, leftRowCenter + 5, gStatsBase + 60, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${losses}`, leftRowCenter + 5, gStatsBase + 80, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(wins / losses)}`, leftRowCenter + 5, gStatsBase + 100, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(kills / deaths)}`, leftRowCenter + 5, gStatsBase + 120, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);

			bgImage = await drawText(bgImage, `${coins}`, rightRowCenter + 5, gStatsBase + 20, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${blocksPlaced}`, rightRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${blocksBroken}`, rightRowCenter + 5, gStatsBase + 60, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${enderPearlsThrown}`, rightRowCenter + 5, gStatsBase + 80, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${eggsThrown}`, rightRowCenter + 5, gStatsBase + 100, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			...
			bgImage = await drawText(bgImage, "Duels", imgWidth / 2 + 350, gStatsBase - 5, 0.65, "#ffffff", true, shadowColor("#ffffff", 0.2), 4, true, true);
			bgImage = await drawMulticoloredText(
				bgImage,
				leftRowCenter,
				gStatsBase + 20,
			...
			bgImage = await drawText(bgImage, `${losses}`, rightRowCenter + 5, gStatsBase + 20, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(wins / losses)}`, rightRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(kills / deaths)}`, rightRowCenter + 5, gStatsBase + 60, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			...
			bgImage = await drawText(bgImage, "The Bridge", imgWidth / 2 + 350, gStatsBase - 5, 0.65, "#ffffff", true, shadowColor("#ffffff", 0.2), 4, true, true);
			bgImage = await drawMulticoloredText(
				bgImage,
				leftRowCenter,
				gStatsBase + 20,
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Goals", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(wins / losses)}`, rightRowCenter + 5, gStatsBase + 20, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(kills / deaths)}`, rightRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${goals}`, rightRowCenter + 5, gStatsBase + 60, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			...
			bgImage = await drawText(bgImage, "Murder Mystery", imgWidth / 2 + 350, gStatsBase - 5, 0.65, "#ffffff", true, shadowColor("#ffffff", 0.2), 4, true, true);
			bgImage = await drawMulticoloredText(
				bgImage,
				leftRowCenter,
				gStatsBase + 20,
			...
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(wins / deaths)}`, rightRowCenter + 5, gStatsBase + 20, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${truncateToThreeDecimals(kills / deaths)}`, rightRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			...
			bgImage = await drawText(bgImage, "Conquests", imgWidth / 2 + 350, gStatsBase - 5, 0.65, "#ffffff", true, shadowColor("#ffffff", 0.2), 4, true, true);
			bgImage = await drawMulticoloredText(
				bgImage,
				leftRowCenter,
				gStatsBase + 20,
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Flags Captured", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Flags Collected", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawText(bgImage, `${deaths}`, leftRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${wins}`, leftRowCenter + 5, gStatsBase + 60, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${flagsCaptured}`, leftRowCenter + 5, gStatsBase + 80, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${flagsCollected}`, leftRowCenter + 5, gStatsBase + 100, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			...
			bgImage = await drawText(bgImage, "UHC", imgWidth / 2 + 350, gStatsBase - 5, 0.65, "#ffffff", true, shadowColor("#ffffff", 0.2), 4, true, true);
			bgImage = await drawMulticoloredText(
				bgImage,
				leftRowCenter,
				gStatsBase + 20,
			...
			bgImage = await drawMulticoloredText(
				...
				0.5,
				[
					["Lapis", "#55FFFF", true, shadowColor("#55FFFF", 0.2), 4, false],
					[":", "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false],
				],
				false,
				true
			...
			bgImage = await drawText(bgImage, `${ironMined}`, rightRowCenter + 5, gStatsBase + 20, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${goldMined}`, rightRowCenter + 5, gStatsBase + 40, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${lapisMined}`, rightRowCenter + 5, gStatsBase + 60, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			bgImage = await drawText(bgImage, `${diamondsMined}`, rightRowCenter + 5, gStatsBase + 80, 0.5, "#FFFFFF", true, shadowColor("#FFFFFF", 0.2), 4, false, false, false);
			...
			bgImage = await drawText(bgImage, "Survival Games", imgWidth / 2 + 350, gStatsBase - 5, 0.65, "#ffffff", true, shadowColor("#ffffff", 0.2), 4, true, true);
			bgImage = await drawMulticoloredText(
				bgImage,
				leftRowCenter,
				gStatsBase + 20,
	...
	const wmBase = 455;
	async function drawMonthlyWeekly() {
		//monthly / weekly
	...
	if (parallel) {
		await Promise.all([drawName(), drawStats(), drawMonthlyWeekly(), drawGstats(), drawWinStreaks()]);
	} else {
		await drawName();
		await drawStats();
		await drawMonthlyWeekly();
		await drawGstats();
		await drawWinStreaks();
	}
